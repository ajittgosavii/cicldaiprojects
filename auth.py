...
def logo_svg(size: int, uid: str) -> str:
    """Hexagon holding a cloud; uid keeps gradient ids unique per page."""
    return (
        ...
        f'<path d="M23 41.5h18a7.2 7.2 0 0 0 0.8-14.3A10.6 10.6 0 0 0 24.4 25.6 7 7 0 0 0 23 41.5z" '
...
def _brand_panel() -> str:
    ...
    return (
        ...
        '<p class="pitch">The catalogue of AI applications delivered by CIS CLD across cloud, data, migration and '
