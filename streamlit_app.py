"""CIS CLD AI Applications: the application portfolio, with pillar filters, a portfolio-mix bar and pagination."""
...
st.set_page_config(page_title="CIS CLD AI Applications", page_icon="☁️", layout="wide")
...
with st.container(key="content"):
    st.markdown(
        ...
        f'<p class="lede">{total} AI applications delivered across cloud, data, migration and security, each with its '
